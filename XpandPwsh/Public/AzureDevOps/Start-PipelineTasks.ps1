    ...
    process {
        ...
        Invoke-Script{
            ...
            if ("UpdateProjectAutoGeneratedBindingRedirects" -in $global:pipelineTasksSet){
                Update-ProjectAutoGenerateBindingRedirects $project $false    
            }
            ...
            if ("AddAssemblyBindingRedirects" -in $global:pipelineTasksSet -and $AssemblyBindingRedirectPackage){
                (Get-ChildItem $ProjectFile.DirectoryName).Name|Where-Object{$_ -in "app.config","Web.config"}|ForEach-Object{
                    $configPath=$_.FullName
                    $AssemblyBindingRedirectPackage|ForEach-Object{
                        Add-AssemblyBindingRedirect -Version $_.Version -Id $_.Id -Path $configPath -PublicToken (Get-XpandPublicKeyToken)
                    }
                }
            }
