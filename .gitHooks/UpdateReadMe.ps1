...
$cmdLetList = Get-XpwshCommand |Sort-Object Name
...
Update-MarkdownHelp -Path "$PSSCriptRoot\..\..\XpandPwsh.wiki" -ErrorAction Continue
...
$regex = [regex] '(?isn)## Exported Functions-Cmdlets(.*)'
$readMeContent = $regex.Replace($readMeContent, @"
