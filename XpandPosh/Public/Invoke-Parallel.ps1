function Invoke-Parallel {
        ...
        #region functions
            Function Get-RunspaceData {
                ...
                Do {
                    ...
                    if (-not $Quiet) {
                        Write-Progress -Id $ProgressId -Activity $activityName -Status "Starting threads"`
    ...
    process {
        ...
        try {
            ...
            if (-not $quiet) {
                Write-Progress -Id $ProgressId -Activity $ActivityName -Status "Starting threads" -Completed
            }
        }
        finally {
